...
Ok, at this point we have a file structure, and raw data - nothing else. But let’s keep going with a simple Rscript to read in the data. Make a script in the src folder and call it something clever like readData.R Try
...
and one that will run all the others. Let’s add the first one readData.R (or whatever you named the file to read in the data).
...
Let’s edit the file now to actually read in the data. You can do this in vim (it is my text editor), or in the text editor of your choice.
