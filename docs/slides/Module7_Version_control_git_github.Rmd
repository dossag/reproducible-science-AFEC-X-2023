...
![](img/window_project_options.png)

]

---
# Introduction to command line interface
![1 commandLineInterface](img/1 commandLineInterface.png)
---
# Introduction to command line interface
![2 commandLineInterface](img/2 commandLineInterface.png)
---

![3 commandLineInterface](img/3 commandLineInterface.png)
---

![4 commandLineInterface](img/4 commandLineInterface.png)
---

![5 commandLineInterface](img/5 commandLineInterface.png)
---

![6 commandLineInterface](img/6 commandLineInterface.png)
---

![7 commandLineInterface](img/7 commandLineInterface.png)
---

![8 commandLineInterface](img/8 commandLineInterface.png)
---

![9 commandLineInterface](img/9 commandLineInterface.png)
---

![10 commandLineInterface](img/10 commandLineInterface.png)
---

![11 commandLineInterface](img/11 commandLineInterface.png)
---

![12 commandLineInterface](img/12 commandLineInterface.png)
---

![13 commandLineInterface](img/13 commandLineInterface.png)
---

![14 commandLineInterface](img/14 commandLineInterface.png)
---

![15 commandLineInterface](img/15 commandLineInterface.png)
---

![16 commandLineInterface](img/16 commandLineInterface.png)
---

![17 commandLineInterface](img/17 commandLineInterface.png)
---

![18 commandLineInterface](img/18 commandLineInterface.png)
---

![19 commandLineInterface](img/19 commandLineInterface.png)
---

![20 commandLineInterface](img/20 commandLineInterface.png)
---

![21 commandLineInterface](img/21 commandLineInterface.png)
---

![22 commandLineInterface](img/22 commandLineInterface.png)
---

![23 commandLineInterface](img/23 commandLineInterface.png)
---

![24 commandLineInterface](img/24 commandLineInterface.png)
---

![25 commandLineInterface](img/25 commandLineInterface.png)
---

![26 commandLineInterface](img/26 commandLineInterface.png)
---

![27 commandLineInterface](img/27 commandLineInterface.png)
---

![28 commandLineInterface](img/28 commandLineInterface.png)
---

![29 commandLineInterface](img/29 commandLineInterface.png)
---

![30 commandLineInterface](img/30 commandLineInterface.png)
---
# Overview of commands in git
![1 basicGitCommands](img/1 basicGitCommands.png)
---
![2 basicGitCommands](img/2 basicGitCommands.png)
---
![3 basicGitCommands](img/3 basicGitCommands.png)
---
![4 basicGitCommands](img/4 basicGitCommands.png)
---

![5 basicGitCommands](img/5 basicGitCommands.png)
---

![6 basicGitCommands](img/6 basicGitCommands.png)
---

![7 basicGitCommands](img/7 basicGitCommands.png)
